...
import {
  EnvName, NsCommand, ObjectiveState, Plan, Snapshot, PublicSettings,
} from '../contract.js';
...
export class Tower {
  ...
  constructor(public paths: Paths) {
    ...
    this.workers = new WorkerRuntime(this.bus, this.registry, this.security, this.transparency, this.router);
